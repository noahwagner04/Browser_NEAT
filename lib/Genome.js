...
NEAT.Genome.prototype.mutateAddConnection = function(tries) {
	...
	*/
	...
	/*
	if there is no valid choices for node1, don't attempt mutate a connection
	this can occur when there are 0 genes in this genome, and we are trying to 
	mutate a recurrent connection
	*/
	if(!(validNode1Choices.length > 0)) return this;
